...
$fields3 = array(
    ...
    array (
        'key' => 'wm_track_ele_from',
        'name' => 'ele:from',
        'label' => 'Altitude of the departure point (in meters)',
        'type' => 'number',
        'instructions' => 'Insert the altitude of the departure point in meters from min of 0 and max of 8848',
        'wpml_cf_preferences' => WEBMAPP_COPY_CUSTOM_FIELD,
        'min' => 0,
        'max' => 8848,
    ),
    array (
        'key' => 'wm_track_ele_to',
        'name' => 'ele:to',
        'label' => 'Altitude of the arrival point (in meters)',
        'type' => 'number',
        'instructions' => 'Insert the altitude of the arrival point in meters from min of 0 and max of 8848',
        'wpml_cf_preferences' => WEBMAPP_COPY_CUSTOM_FIELD,
        'min' => 0,
        'max' => 8848,
    ),
    array (
        'key' => 'wm_track_ele_max',
        'name' => 'ele:max',
        'label' => 'Maximum altitude of the track (in meters)',
        'type' => 'number',
        'instructions' => 'Insert the maximum altitude of the track in meters from min of 0 and max of 8848',
        'wpml_cf_preferences' => WEBMAPP_COPY_CUSTOM_FIELD,
        'min' => 0,
        'max' => 8848,
    ),
    array (
        'key' => 'wm_track_ele_min',
        'name' => 'ele:min',
        'label' => 'Minimum altitude of the track (in meters)',
        'type' => 'number',
        'instructions' => 'Insert the minimum altitude of the track in meters from min of 0 and max of 8848',
        'wpml_cf_preferences' => WEBMAPP_COPY_CUSTOM_FIELD,
        'min' => 0,
        'max' => 8848,
    ),
