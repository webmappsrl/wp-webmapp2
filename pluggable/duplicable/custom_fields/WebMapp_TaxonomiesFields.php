...
$fields3 = array(
	...
	'fields' => array(
        ...
        array(
			...
			'name' => 'min_size_zoom',
			'type' => 'number',
			'instructions' => 'Insert the minimum zoom from which the POI becomes visible in the map using "Min size" size. From this zoom to "Icon zoom" the size is being scaled. The value should be between 0 and 17 (less than Icon zoom).',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
        ...
        array(
			...
			'name' => 'min_size',
			'type' => 'number',
            'instructions' => 'Insert the minimum size (applied to "Min size zoom"). The value should be a number equal or greater than 0 (with value 0 the POI is not visible).',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
        ...
        array(
			...
			'name' => 'max_size',
			'type' => 'number',
            'instructions' => 'Insert the maximum size (applied up to "Icon zoom"). The value should be a number equal or greater than 0 (with value 0 the POI is not visible).',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
        ...
        array(
			...
			'name' => 'icon_size',
			'type' => 'number',
            'instructions' => 'Insert the POI icon size (visible from "Icon zoom" in on, which is a constant size). The value should be a number equal or greater than 0 (with value 0 the POI is not visible).',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '',
